This is a [Laravel](https://Exclusiveunlock.org/) project bootstrapped with `composer create-project Exclusiveunlock/Exclusiveunlock Exclusiveunlock-wasmer-example` (with some minor adaptations for Wasmer).
